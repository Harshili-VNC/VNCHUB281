  ...
  if (tab === "identity") {
    ...
    if (!f.accounts || f.accounts.length !== f.numberOfAccounts) {
      ...
      f.accounts.forEach((acc, i) => {
        ...
        if (!acc.billingEntity) errors.push(`Account #${i + 1} Billing Entity is required`);
        if (!acc.currency) errors.push(`Account #${i + 1} Currency is required`);
        if (!acc.taxRegistrationNumber.trim())
          errors.push(`Account #${i + 1} GST / Tax Registration Number is required`);
        ...
        <DialogContent className="sm:max-w-3xl max-h-[90vh] overflow-y-auto">
          ...
          {activeFormTab === "address" && (
            <div className="grid grid-cols-2 gap-3 pt-2">
              ...
              <div>
                <Label>
                  Zip / PIN Code <span className="text-rose-500 font-bold">*</span>
                </Label>
                <Input
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3 pt-1 text-xs">
                        ...
                        <div>
                          ...
                          >
                            <SelectTrigger
                              className={`h-9 text-xs ${!acc.billingEntity && !form.billingEntity ? "border-rose-500/50" : ""}`}
                            >
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div>
                          ...
                          >
                            <SelectTrigger
                              className={`h-9 text-xs ${!acc.currency && !form.currency ? "border-rose-500/50" : ""}`}
                            >
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div>
                          <Label className="text-[11.5px]">
                            GST / Tax Registration Number / PAN{" "}
                            <span className="text-rose-500 font-bold">*</span>
                          </Label>
                          <Input
                            ...
                            className={
                              !acc.taxRegistrationNumber.trim() ? "border-rose-500/50" : ""
                            }
                          />
                        </div>
                        <div className="col-span-2">
                          ...
                          <Input
                            ...
                            className={!acc.addressLine1.trim() ? "border-rose-500/50" : ""}
                          />
                        </div>
                        <div>
                          <Label className="text-[11.5px]">
                          ...
                          <Input
                            ...
                            className={!acc.city.trim() ? "border-rose-500/50" : ""}
                          />
                        </div>
                        <div>
                          <Label className="text-[11.5px]">
                          ...
                          <Input
                            ...
                            className={!acc.stateOrRegion.trim() ? "border-rose-500/50" : ""}
                          />
                        </div>
                        <div>
                          <Label className="text-[11.5px]">
                          ...
                          <Input
                            ...
                            className={!acc.country.trim() ? "border-rose-500/50" : ""}
                          />
                        </div>
                        <div>
                          <Label className="text-[11.5px]">
                          ...
                          <Input
                            ...
                            className={!acc.zipOrPinCode.trim() ? "border-rose-500/50" : ""}
                          />
                        </div>
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              updateAccountField(idx, "industryCode", e.target.value)
                            }
