          ...
          <div className="space-y-6 pt-2">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 p-4 rounded-2xl border border-border bg-surface-2/50 text-xs">
              ...
              <div>
                ...
                <span className="font-semibold text-foreground">{client.currency || "USD"}</span>
              </div>
              <div>
            ...
            <div className="p-4 rounded-2xl border border-border bg-surface-2/30 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div className="col-span-2">
                  <span className="text-muted-foreground block text-[11px]">Address Line 1</span>
                  <span className="font-medium">{client.clientAddressLine1 || "—"}</span>
                </div>
                {client.clientAddressLine2 && (
                  <div className="col-span-2">
                    <span className="text-muted-foreground block text-[11px]">Address Line 2</span>
                ...
                <div>
                  <span className="text-muted-foreground block text-[11px]">State / Region</span>
                ...
                <div>
                  ...
                  <span className="font-medium">{client.clientCountry || "—"}</span>
                </div>
                <div>
