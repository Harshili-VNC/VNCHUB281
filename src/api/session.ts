...
// See src/db/client.ts for why we call config() directly instead of
// importing "dotenv/config" (which crashes with
// "Cannot read properties of undefined (reading 'reduce')" in this app's
// server/edge runtime).
loadEnv();
