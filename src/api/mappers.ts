...
export function toPerson(
  ...
  designationLevelName: string | null,
): Person {
  return {
    id: row.id,
    ...
    currentActiveForPlanning: row.currentActiveForPlanning,
    standardMonthlyCapacityHours: row.standardMonthlyCapacityHours,
    standardProjectHours: row.standardProjectHours,
    standardProjectActivityHours: row.standardProjectActivityHours,
    standardOrganisationalActivityHours: row.standardOrganisationalActivityHours,
    roleTags: parseJsonArray(row.roleTags),
    notesRemarks: row.notesRemarks,
    status: row.status,
...
export function toClientAccount(row: ClientAccountRow): ClientAccount {
  return {
    ...
    accountLegalStructure: row.accountLegalStructure,
    addressLine1: row.addressLine1,
    addressLine2: row.addressLine2,
    country: row.country,
    stateOrRegion: row.stateOrRegion,
    city: row.city,
    zipOrPinCode: row.zipOrPinCode,
    industryCode: row.industryCode,
    revenueLast1Year: row.revenueLast1Year,
